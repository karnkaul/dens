...
TEST(decf_multiple) {
	...
	{
		registry r2;
		auto e1 = r1.make_entity();
		e2 = r2.make_entity();
		EXPECT_EQ(r2.contains(e1), false);
		EXPECT_EQ(r1.contains(e2), false);
		EXPECT_EQ(r2.contains(e2), true);
		EXPECT_EQ(r1.contains(e1), true);
		r2.clear();
		EXPECT_EQ(r2.contains(e2), false);
	}
	EXPECT_EQ(r1.contains(e2), false);
}
